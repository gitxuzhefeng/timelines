...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            api::list_external_ai_providers,
            api::export_external_ai_summary_bundle,
            api::send_to_external_ai_summary,
            ...
            api::get_today_briefing,
            api::get_weekly_briefing,
            api::get_assistant_history,
            api::clear_assistant_history,
            api::get_assistant_context,
            api::get_assistant_context_extended,
            api::query_assistant,
            api::query_assistant_v2,
